...
var answers = [
    "我們兩個社團最主要的差別在於友社，我們的友社包含中山資研、景美電資、成功電研，四個資訊類社團組成所謂的IZCC，平常的活動與小社課(放課)都是IZCC一同舉辦，而建電則是與北一資研合作組成建北電資。如果想要認識友校的好朋朋，那加入資訊社準沒錯啦。",
    "資訊社與機研的差別主要是研究著手的方向不同，機研主要在進行機器人開發，程式的部分也是針對機器人的，而我們則是與資訊相關的東西都會接觸到，不會只侷限於一個領域，不管是程式語言、機器學習、網頁設計等等，如果你喜歡程式、想要學習最新資訊相關的酷東西，那肯定是來資訊社的！",
